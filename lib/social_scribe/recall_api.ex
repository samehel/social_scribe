defmodule SocialScribe.RecallApi do
  ...
  @callback get_participant_events(participant_events_id :: String.t()) ::
              {:ok, Tesla.Env.t()} | {:error, any()}
  ...
  def get_transcript(transcript_id) do
    impl().get_transcript(transcript_id)
  end

  def get_participant_events(participant_events_id) do
    impl().get_participant_events(participant_events_id)
  end
